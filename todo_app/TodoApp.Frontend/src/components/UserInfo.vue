<template>
  <footer class="info">
    ...
    <div class="bottom">
      ...
      Part of <a href="http://todomvc.com">TodoMVC project</a></p>
			<p>Adapted for Vue3 + Azure Static Web Apps + Data API Builder + Azure SQL by <a href="http://davidemauri.it">Davide Mauri</a></p>                
