  ...
  methods: {
    ...
    completeTodo: function (todo) {
      fetch(API + `/id/${todo.id}`, {
        headers: HEADERS,
        method: "PATCH",
        body: JSON.stringify({ completed: todo.completed, order: todo.order, owner_id: this.userId })
      });
    },
    ...
    doneEdit: function (todo) {
      ...
      if (!todo.title) {
        ...
        fetch(API + `/id/${todo.id}`, {
          headers: HEADERS,
          method: "PATCH",
          body: JSON.stringify({ title: todo.title, order: todo.order, owner_id: this.userId })
        });
      }
    },
